...
function UserDetailPage() {
    ...
    return (
        <div className="p-8">
            ...
            <h1 className="text-3xl font-bold mb-8">회원 상세</h1>
            ...
            <div className="bg-white p-6 rounded-lg shadow mb-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <div className="font-medium">{user.gender === 'male' ? '남성' : '여성'}</div>
                    </div>
                    <div>
                    ...
                    <div>
                        <div className="text-sm text-gray-500">출생시간</div>
                        <div className="font-medium">{user.birth_time || '-'}</div>
                    </div>
                    <div>
            ...
            <div className="bg-white p-6 rounded-lg shadow">
                <h2 className="text-xl font-bold mb-4">AI 토큰 사용 내역</h2>
                {tokens.length === 0 ? (
